---
title: Series overview and the six beats
type: series
tags: [series, overview, six-beats, schedule]
captured: 2026-07-14
...
The through-lines of the whole series. The intro plants all six; the next three
streams each deliver a share.

1. Information is more abundant than ever. Making it work is harder than ever.
2. Most of us consume thousands of ideas, but almost none of them compound.
3. A second brain isn't a folder system. It's a compounding knowledge system.
4. AI changes the game: not just retrieval, reasoning together.
5. Structure — markdown, metadata, links — is the enabler.
6. The goal isn't a vault, it's better thinking and better decisions.

## How the beats map to the weeks
...
- [[Finished example/01_Strategy/north-star]] — the sentence under all six beats.
- [[Finished example/02_Audience/what-you-get]] — what the viewer holds after each part.
